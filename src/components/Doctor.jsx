                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-md-6">
                        <h1 className="text-left">Name: {doctor.name}</h1>
                        <div className="row">
                          <div className="col-md-12">
                            <h1 className="text-left">Speciality: {doctor.speciality}</h1>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-md-12">
                            <h1 className="text-left">Hospital: {doctor.hospital}</h1>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-md-12">
                            <h1 className="text-left">City: {doctor.city}</h1>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <Image className="d-block img-fluid" src={x}/>
                      </div>
                    </div>
                  </div>
                </div>
